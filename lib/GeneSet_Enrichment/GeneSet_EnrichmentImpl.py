...
class GeneSet_Enrichment:
    ...
    ######################################### noqa
    VERSION = "0.0.1"
    GIT_URL = "https://github.com/kbasecollaborations/GeneSet_Enrichment"
    GIT_COMMIT_HASH = "d806235a6a09c90d564bb58aaf95cf9be7a3acd9"
    ...
    def build_Featureset(self, ctx, params):
        ...
        :param params: instance of type "featuresetparams" -> structure:
           parameter "obj_name" of String, parameter "workspace_name" of
           String, parameter "genes" of String
        :returns: instance of type "ReportResults" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        """
        # ctx is the context object

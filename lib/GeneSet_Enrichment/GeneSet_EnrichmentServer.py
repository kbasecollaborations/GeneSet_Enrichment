...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'GeneSet_Enrichment'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from GeneSet_Enrichment.GeneSet_EnrichmentImpl import GeneSet_Enrichment  # noqa @IgnorePep8
impl_GeneSet_Enrichment = GeneSet_Enrichment(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'GeneSet_Enrichment'
        ...
        self.rpc_service.add(impl_GeneSet_Enrichment.run_GeneSet_Enrichment,
